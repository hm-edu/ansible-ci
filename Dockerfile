...
COPY --from=docker.io/tailscale/tailscale:v1.86.5@sha256:9e2bfdd9e2ce724df53f976d06a4a9933aa730dc655ace42798f4c73735d1cac /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
