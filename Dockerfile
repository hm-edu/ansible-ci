...
COPY --from=docker.io/tailscale/tailscale:v1.90.5@sha256:8528b4f401c950308efc5cdb32b7030c3dc3c3f41884b6f1af25157a7ae051bb /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
