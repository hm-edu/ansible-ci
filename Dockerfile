...
COPY --from=docker.io/tailscale/tailscale:v1.82.0@sha256:d26fc9bb035b0559900cc6f23506f6b1ddab61a690ffab4f5d84feceb3de811e /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
