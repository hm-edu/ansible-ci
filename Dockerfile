...
COPY --from=docker.io/tailscale/tailscale:v1.90.6@sha256:8eb8b450a85856807e8a216c4697333e15f8701cb6d344bed851bf6aa6a9605c /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
