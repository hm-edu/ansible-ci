...
COPY --from=docker.io/tailscale/tailscale:v1.86.2@sha256:241d9518b7e0b6e533dbd0117fcea15acb4174249210837f52b71615949ce9d2 /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
