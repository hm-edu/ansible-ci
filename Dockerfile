...
COPY --from=docker.io/tailscale/tailscale:v1.80.3@sha256:af6026ed3e5892c5d4966962618a09685198111507df16803b2aec7066046582 /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
