...
COPY --from=docker.io/tailscale/tailscale:v1.92.4@sha256:d6734d69fd7d31b1861589e347463954aa6097f9a61aa4f8f763ba94bfe0e5b9 /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
