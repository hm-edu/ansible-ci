...
COPY --from=docker.io/tailscale/tailscale:v1.84.3@sha256:f97ea471667bd94023f76e228c5be0b95564cdba2f9501cb084eeef139d8b65e /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
