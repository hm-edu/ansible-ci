...
COPY --from=docker.io/tailscale/tailscale:v1.88.4@sha256:360e10ad95ad03950f66df03e0dab66287f9f89076ee4012d50bc6adceafcdf3 /usr/local/bin/tailscaled /usr/local/bin/tailscale /usr/local/bin/
